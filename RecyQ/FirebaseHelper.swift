            ...
            if error != nil {
                ...
                FIRAuth.auth()?.signIn(withEmail: newUser.addedByUser, password: withPassword, completion: { (user, error) in
                    ...
                    if error != nil {
                        ...
                        currentUser = User(dateCreated: newUser.dateCreated, name: newUser.name.lowercased(), lastName: newUser.lastName!, address: newUser.address!, zipCode: newUser.zipCode!, city: newUser.city!, phoneNumber: newUser.phoneNumber!, addedByUser: newUser.addedByUser, nearestWasteLocation: newUser.nearestWasteLocation!, didReceiveRecyQBags: newUser.didReceiveRecyQBags, completed: false, amountOfPlastic: newUser.amountOfPlastic, amountOfPaper: newUser.amountOfPaper, amountOfTextile: newUser.amountOfTextile, amountOfEWaste: newUser.amountOfEWaste, amountOfBioWaste: newUser.amountOfBioWaste,amountOfGlass: newUser.amountOfGlass, wasteDepositInfo: nil, uid: (user?.uid)!, spentCoins: newUser.spentCoins)
